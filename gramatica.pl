...
%sentenca([o,professor,gosta,de,bola],[]).

%sentenca(LF,[o,professor,'é',cego],[]).
...
sentenca(LF) --> periodoSimples(LF).
sentenca(LF) --> periodoComposto(LF).
sentenca(LF) --> frase(LF, Numero,Genero).

periodoSimples(LF) --> predicado(LF, Numero,Genero).
periodoSimples(SU^LF) --> sujeito(SU, Numero,Genero), predicado(LF, Numero,Genero).

periodoComposto(LF) --> oracaoCoordenada(LF, Numero,Genero).
periodoComposto(LF) --> oracaoCoordenada(LF, Numero,Genero), sentenca(LF).
periodoComposto(LF) --> oracaoCoordenada(LF, Numero,Genero), conjuncao, sentenca(LF).
periodoComposto(LF) --> oracaoSubordinada(LF, Numero,Genero).
periodoComposto(LF) --> oracaoSubordinada(LF, Numero,Genero), sentenca(LF).
periodoComposto(LF) --> oracaoSubordinada(LF, Numero,Genero), preposicao(_),sentenca(LF).
periodoComposto(LF) --> oracaoCoordenada(LF, Numero,Genero), conjuncao, oracaoSubordinada(LF, Numero,Genero).
periodoComposto(LF) --> oracaoSubordinada(LF, Numero,Genero), conjuncao, oracaoCoordenada(LF, Numero,Genero).

% oração subordinada adjetiva
periodoComposto(X^LF2&Y^SU&X^S&Y^X^V) --> sujeito(SU, Numero,Genero), conjuncao, predicado(S^V, Numero,Genero), predicado(LF2, Numero,Genero).

oracaoCoordenada(LF, Numero,Genero) --> predicado(LF, Numero,Genero).
oracaoCoordenada(LF, Numero,Genero) --> sujeito(LF, Numero,Genero), predicado(LF, Numero,Genero).
oracaoSubordinada(LF, Numero,Genero) --> predicado(LF, Numero,Genero).
oracaoSubordinada(LF, Numero,Genero) --> sujeito(LF, Numero,Genero), predicado(LF, Numero,Genero).

frase(LF, Numero,Genero) -->  sujeito(LF, Numero,Genero).
frase(LF, Numero,Genero) -->  artigo(Numero,Genero) , sujeito(LF, Numero,Genero).
frase(LF, Numero,Genero) -->  artigo(Numero,Genero) , sujeito(LF, Numero,Genero).

sujeito(SU, Numero,Genero) --> [SU], {substantivo(Numero,Genero,[SU|_],[])}.
sujeito(SU, Numero,Genero) --> [todo], [SU], {substantivo(Numero,Genero,[SU|_],[])}.
sujeito(LF, Numero,Genero) --> pronome(Numero).
sujeito(LF, Numero,Genero) --> pronome(Numero,Genero).
sujeito(LF, Numero,Genero) --> substantivo(Numero,Genero).
sujeito(LF, Numero,Genero) --> artigo(Numero,Genero) , substantivo(Numero,Genero), preposicao(_).
sujeito(LF, Numero,Genero) --> adverbio(Numero), adjetivo(Numero,Genero).
sujeito(SU, Numero,Genero) --> artigo(Numero,Genero), [SU], {substantivo(Numero,Genero,[SU|_],[])}.
sujeito(LF, Numero,Genero) --> artigo(Numero,Genero) , substantivo(Numero,Genero), adjetivo(Numero,Genero).
sujeito(LF, Numero,Genero) --> substantivo(Numero,Genero) , conjuncao, substantivo(Numero,Genero).


%predicados nominais
predicado(LF, Numero,Genero) --> ['é'], [LF], {substantivo(Numero,Genero,[LF|_],[])}.

predicado(LF, Numero,Genero) --> ['é'], [um], [LF], {substantivo(Numero,Genero,[LF|_],[])}.


predicado(V, Numero,Genero) --> [V], {verbo(Numero,[V|_],[])}. 
predicado(S^V, Numero,Genero) --> [V], [S], {substantivo(Numero,Genero,[S|_],[])}, {verbo(Numero,[V|_],[])}.
predicado(S^V, Numero,Genero) --> [V], [um], [S], {substantivo(Numero,Genero,[S|_],[])}, {verbo(Numero,[V|_],[])}. 
predicado(LF, Numero,Genero) --> verbo(Numero), adjetivo(Numero,Genero).
predicado(LF, Numero,Genero) --> verbo(Numero), substantivo(Numero,Genero), adjetivo(Numero,Genero).
predicado(LF, Numero,Genero) --> verbo(Numero), artigo(Numero,Genero), adjetivo(Numero,Genero).
predicado(LF, Numero,Genero) --> verbo(Numero), artigo(Numero,Genero), substantivo(Numero,Genero).
predicado(LF, Numero,Genero) --> verbo(Numero), artigo(Numero,Genero), substantivo(Numero,Genero), adjetivo(Numero,Genero).
predicado(S^V, Numero,Genero) --> [V], [todo], [S], {substantivo(Numero,Genero,[S|_],[])}, {verbo(Numero,[V|_],[])}. 
predicado(LF, Numero,Genero) --> verbo(Numero), artigo(Numero,Genero), pronome(Numero,_), substantivo(Numero,Genero), preposicao(_), verbo(Numero).
predicado(LF, Numero,Genero) --> verbo(Numero), numeral(Numero,Genero), substantivo(Numero,Genero).
predicado(LF, Numero,Genero) --> verbo(Numero), numeral(Numero,Genero), substantivo(Numero,Genero), adjetivo(Numero,Genero).
predicado(LF, Numero,Genero) --> verbo(Numero), preposicao(_), substantivo(Numero,Genero).
predicado(LF, Numero,Genero) --> verbo(Numero), preposicao(_), substantivo(Numero,Genero), preposicao(_), adjetivo(Numero,Genero),substantivo(Numero,Genero).
predicado(LF, Numero,Genero) --> verbo(Numero), preposicao(_), verbo(Numero), adverbio(Numero,Genero), adjetivo(Numero,Genero). 
predicado(LF, Numero,Genero) --> verbo(Numero), substantivo(Numero,Genero), artigo(Numero,Genero), substantivo(Numero,Genero).
predicado(LF, Numero,Genero) --> verbo(Numero), substantivo(Numero,Genero), artigo(Numero,Genero), substantivo(Numero,Genero), adjetivo(Numero,Genero).
...
pronome(interrogativo,sem_genero) --> [por|[que]].
pronome(interrogativo,sem_genero) --> [que].
pronome(interrogativo,sem_genero) --> [quem].
pronome(interrogativo,masculino) --> [o|[qual]].
pronome(interrogativo,feminino) --> [a|[qual]].
...
substantivo(singular, masculino) --> [bertrand].
substantivo(singular, feminino) --> [principia].
...
substantivo(singular, feminino) --> [cega].
...
substantivo(singular, masculino) --> [livro].
substantivo(singular, feminino) --> [livro].

substantivo(singular, masculino) --> [programa].
substantivo(singular, masculino) --> [autor].
substantivo(singular, masculino) --> [estudante].


%VERBO
verbo(singular) --> [escreve].
verbo(singular) --> [persegue].
verbo(singular) --> [conhece].
...
interrogacao(LF => resp) --> pronome(interrogativo,sem_genero), sentenca(LF), ['?'].
interrogacao(LF => resp) --> sentenca(LF), ['?'].